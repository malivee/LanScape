            ...
            VStack(spacing: isPad ? 16 : 8) {
                ...
                ZStack {
                    ...
                    Circle()
                        ...
                        .shadow(color: (visionHandTracker.isHighFiveDetected ? Color.green : Color(hex: "10B981")).opacity(0.5), radius: isPad ? 20 : 14)
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text(visionHandTracker.isHighFiveDetected ? "Tosss Terdeteksi!" : "Angkat Telapak")
                            ...
                            .foregroundColor(visionHandTracker.isHighFiveDetected ? .green : Color(hex: "D1FAE5"))
                    }
                }
