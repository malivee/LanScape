//
//  CheekToCheekChallengeView.swift
//  LanScape
//

import SwiftUI

struct CheekToCheekChallengeView: View {
    ...
    @State private var pulseFrame: Bool = false
    ...
    var body: some View {
        ...
        ZStack {
            ...
            // Vintage Frame Overlay that becomes more golden as progress fills
            RoundedRectangle(cornerRadius: 24)
                .stroke(
                    LinearGradient(
                        colors: [Color(hex: "F59E0B").opacity(Double(progress)), Color(hex: "D97706").opacity(Double(progress))],
            ...
            VStack(spacing: isPad ? 16 : 8) {
                ...
                Button(action: {
                    ...
                    ZStack {
                        Circle()
                            ...
                            .scaleEffect(pulseFrame ? 1.08 : 0.98)
                            .opacity(pulseFrame ? 0.9 : 0.4)
                            .animation(.easeInOut(duration: 0.8).repeatForever(autoreverses: true), value: pulseFrame)
                        ...
                        VStack(spacing: 4) {
                            Text("🫂")
                                ...
                                .scaleEffect(pulseFrame ? 1.12 : 0.95)
                                .animation(.spring(response: 0.4, dampingFraction: 0.6).repeatForever(autoreverses: true), value: pulseFrame)
                ...
                VStack(spacing: isPad ? 8 : 5) {
                    Text(progress > 0.6 ? "FOTO SANGAT HANGAT!" : "LETSGOOO...!!!")
                ...
                HStack(spacing: 6) {
                    Image(systemName: "person.2.fill")
                        ...
                        .foregroundColor(Color(hex: "FCD34D"))
                    Text("Kakek & Cucu saling memiringkan kepala bersandar ke kamera")
    ...
    private func startChallenge() {
        ...
        timerTask = Task { @MainActor in
            while timeRemaining > 0 && !isFinished {
                ...
                // Holding the cheek to cheek pose reliably fills progress
                registerBoost(0.035)
