    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack(spacing: isPad ? 16 : 8) {
                ...
                ZStack {
                    Circle()
                        .stroke(visionHandTracker.isFishLipsActive ? Color.green : Color(red: 0.15, green: 0.45, blue: 0.95), lineWidth: isPad ? 6 : 4)
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text(visionHandTracker.isFishLipsActive ? "Bibir Monyong!" : "Monyongkan Bibir")
                            ...
                            .foregroundColor(visionHandTracker.isFishLipsActive ? Color(hex: "059669") : Color(hex: "1E293B"))
                    }
                }
                ...
                VStack(spacing: isPad ? 7 : 4) {
                    ...
                    GeometryReader { geo in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                .fill(LinearGradient(colors: [Color(red: 0.15, green: 0.45, blue: 0.95), Color(hex: "10B981")], startPoint: .leading, endPoint: .trailing))
