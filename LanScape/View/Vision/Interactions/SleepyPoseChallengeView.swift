    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack(spacing: isPad ? 16 : 8) {
                ...
                ZStack {
                    Circle()
                        .stroke(visionHandTracker.isHandBesideFace ? Color.green : Color(hex: "6366F1"), lineWidth: isPad ? 6 : 4)
                    ...
                    Circle()
                        ...
                        .overlay(
                            Circle().stroke(Color(hex: "6366F1").opacity(0.4), lineWidth: 1.5)
                        )
                        .shadow(color: (visionHandTracker.isHandBesideFace ? Color.green : Color(hex: "6366F1")).opacity(0.5), radius: isPad ? 20 : 14)
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text(visionHandTracker.isHandBesideFace ? "Pose Terdeteksi!" : "Pose Bobo")
                            ...
                            .foregroundColor(visionHandTracker.isHandBesideFace ? .green : Color(hex: "E0E7FF"))
                    }
                }
