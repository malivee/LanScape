...
struct MiniGameCatalog {
    static let allGames: [MiniGameID: MiniGameMetadata] = [
        ...
        .handClap: MiniGameMetadata(
            ...
            tutorialInstruction: "Kakek & Cucu kompak tepuk tangan 10 kali di depan kamera!",
            tutorialTip: "Tepuk tangan dengan ceria 10 kali sampai selesai!",
            actionPrompt: "AYO TEPUK TANGAN 10 KALI!",
            cheerText: "LETSGOOO...!!!",
